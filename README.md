...
[![built with garnix](https://img.shields.io/endpoint?url=https%3A%2F%2Fgarnix.io%2Fapi%2Fbadges%2Fsellout%2Fhaskerwaul)](https://garnix.io/repo/sellout/haskerwaul)
...
See the individual package READMEs for usage information

- [`haskerwaul`](./haskerwaul/README.md) – the core library
- [`haskerwaul-base`](./haskerwaul-base/README.md) – a mostly drop-in replacement for `base`
- [`haskerwaul-hedgehog`](./haskerwaul-hedgehog/README.md) – integration with [Hedgehog](https://github.com/hedgehogqa/haskell-hedgehog#readme) for testing Haskerwaul
- [`haskerwaul-trample`](./haskerwaul-trample/README.md) – like `haskerwaul-base`, but with identical package names as `base`
...
See [the package README](./haskerwaul/README.md) for comparisons with other similar projects.
