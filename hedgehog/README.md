# Haskerwaul’s Hedgehog integration

[![Packaging status](https://repology.org/badge/tiny-repos/haskell:haskerwaul-hedgehog.svg)](https://repology.org/project/haskell:haskerwaul-hedgehog/versions)
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:haskerwaul-hedgehog.svg)](https://repology.org/project/haskell:haskerwaul-hedgehog/versions)

## usage

If you use Haskerwaul, this package can help you write tests fairly abstractly. It implements an `ElementaryTopos` for Hedgehog, which can then be used to test various properties.
