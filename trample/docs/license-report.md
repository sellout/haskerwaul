...
## Direct dependencies of `haskerwaul-trample:lib:haskerwaul-trample`

| Name | Version | [SPDX](https://spdx.org/licenses/) License Id | Description | Also depended upon by |
| --- | --- | --- | --- | --- |
| `haskerwaul-base` | [`0.1.0.0`](http://hackage.haskell.org/package/haskerwaul-base-0.1.0.0) |  *MISSING* | *MISSING* |  |
...
| `haskerwaul` | [`0.1.0.0`](http://hackage.haskell.org/package/haskerwaul-0.1.0.0) |  *MISSING* | *MISSING* | `haskerwaul-base` |
